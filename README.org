...
#+begin_src ocaml :exports both :results pp
  ...
  let results = Q.find_docs [ "one"; "content" ] index';;
  List.iter ~f:(fun r -> Printf.printf "Found document: %s\n" (Sexp.to_string (Index.QueryResult.sexp_of_t r))) results
#+end_src

#+RESULTS:
: Found document: ((doc_id 620e6c2c1fb0eaaabb6061f7daa5f98d)(token_entries(((token one)(positions(32))(flags((title false)(directory false)(extension false)(source false))))((token content)(positions(12))(flags((title false)(directory false)(extension false)(source false)))))))
: - : unit = ()
